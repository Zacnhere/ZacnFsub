...
from PremSub import LOOP, Bot, bot, LOGGER
from PremSub.config import LOG_GRP
from PremSub.modules import loadModule
from PremSub.modules.data import get_bot, remove_bot
from PremSub.modules.plernya import *
...
# async def auto_restart():
    # while not await asyncio.sleep(7200):
        # def _():
            # os.system(f"kill -9 {os.getpid()} && python3 -m PremSub")
        # register(_)
        # sys.exit(0)
